...
public class NoteAdapter extends BaseAdapter implements Filterable {
    ...
    private List<DailyTask> backList;//用来备份原始数据
    private List<DailyTask> noteList;//这个数据是会改变的，所以要有个变量来备份一下原始数据
    private MyFilter mFilter;

    public NoteAdapter(Context mContext, List<DailyTask> noteList) {
